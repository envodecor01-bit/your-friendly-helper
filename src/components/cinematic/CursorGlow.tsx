...
export function CursorGlow() {
  ...
  return (
    <>
      ...
      <div
        ref={glowRef}
        className="pointer-events-none fixed top-0 left-0 z-30 w-[400px] h-[400px] rounded-full"
        style={{
          background: "radial-gradient(circle, oklch(0.72 0.13 240 / 0.09), transparent 68%)",
          filter: "blur(36px)",
          mixBlendMode: "screen",
        }}
      />
